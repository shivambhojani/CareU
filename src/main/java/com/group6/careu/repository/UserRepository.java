...
public interface UserRepository extends CrudRepository<User, Integer> {
    ...
    @Query(value = "SELECT * from users u join doctors d on u.doctor_id = d.doctor_id where u.first_name like %:keyword%" +
            " or u.last_name like %:keyword% or d.doctor_spel like %:keyword% or d.doctor_reg_number like %:keyword% " +
    ...
    public User getUserByDoctor(@Param("doctor_id") int doctor_id);
